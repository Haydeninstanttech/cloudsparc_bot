In order to install the bot, run the 'setup.bat' file in order to install the node_modules. After running that file go into the 'config.json' file and configure to your liking.
